                        ...
                        <ul class="navbar-nav header-right main-notification">
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link bell dz-theme-mode" href="#">
                                    ...
                                    <!-- theme button changne dark and white mode -->
                                </a>
							</li>
							<li class="nav-item dropdown notification_dropdown">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<div class="main-profile">
					<div class="image-bx">
					<img src="{{ asset('images/buksulogo.png') }}" alt="">

						
					</div>
					<h5 class="name"><span class="font-w400"></span>BUKIDNON STATE UNIVERSITY</h5>
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="{{ route('tenants.index')}}">View All Depatrment</a></li>
							<li><a href="{{ route('tenants.create')}}">Add new Department</a></li>
							<li><a href="my-wallets.html">Announcement</a></li>
							<li><a href="tranasactions.html">View all Admin Department</a></li>
							<li><a href="portofolio.html">Instructors</a></li>
						</ul>
