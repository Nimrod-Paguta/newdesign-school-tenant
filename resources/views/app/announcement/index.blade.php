    ...
    <div class="row-sm-4 my-custom-padding-top my-custom-padding-left">
        <div class="card my-custom-height">
            ...
            <h5 class="card-title"><strong>Date:</strong> <span class="value">{{ $announcement->date }}</h5>
                ...
                <form action="{{ route('announcement.destroy', $announcement->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this announcement?');">
                    @csrf
                    @method('DELETE')
