   ...
   <div class="card mb-4">
     <div class="card-body">
       <div class="row">
         ...
         <div class="col-sm-9">
           <p class="text-muted mb-0">{{ $student->adminfirstname }} {{ $student->adminmiddlename }} {{ $student->adminlastname }}</p>
         </div>
       </div>
       <hr>
       ...
       <div class="row">
         ...
         <div class="col-sm-9">
           <p class="text-muted mb-0">{{ $student->barangay }}, {{ $student->municipality }}, {{ $student->province }}</p>
         </div>
       </div>
       <hr>
       <div class="row">
         ...
         <div class="col-sm-9">
           <p class="text-muted mb-0">{{ $student->contactnumber }}</p>
         </div>
       </div>
       <hr>
       @if ($student->id != 1)
